    ...
    <footer style={{ background: "#0A0A0F", borderTop: "1px solid #1E1E3A" }}>
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid md:grid-cols-3 gap-8 items-start mb-10">
          ...
          <div>
            <h4
              ...
              style={{ color: "#fff", fontFamily: "'Space Grotesk', sans-serif", fontWeight: 600 }}
            >
              Quick Links
            </h4>
          ...
          <div>
            ...
            <div className="flex gap-3 mb-4">
              {[
                ...
                <a
                  ...
                  style={{ background: "#13131F", border: "1px solid #1E1E3A", color: "#A0A0B8" }}
                  onMouseEnter={(e) => {
            ...
            <div
              ...
              style={{ color: "#A0A0B8", fontFamily: "'JetBrains Mono', monospace" }}
            >
              <span
        ...
        <div
          ...
          style={{ borderTop: "1px solid #1E1E3A", color: "#A0A0B8", fontFamily: "'Inter', sans-serif" }}
        >
          <span>© 2024 Pruthviraj. All rights reserved.</span>
          <span>
            Made with Django &{" "}
